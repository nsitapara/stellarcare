    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("appointments", models.ManyToManyField(to="api.appointment")),
                ("cpap_usage", models.ManyToManyField(to="api.cpapusage")),
                ("custom_fields", models.ManyToManyField(to="api.customfield")),
                ("insurance", models.ManyToManyField(to="api.insurance")),
                ("medications", models.ManyToManyField(to="api.medication")),
                ("sleep_studies", models.ManyToManyField(to="api.sleepstudy")),
            ],
        ),
    ]
